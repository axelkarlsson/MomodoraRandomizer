...
internal static class PointerMetadata{
    public static readonly Dictionary<PointerNames, int[]> Offsets_105b = new() {
        { PointerNames.LEVEL_ID, [0x230F1A0] }
    };

    public static readonly Dictionary<PointerNames, int[]> Offsets_107 = new() {
    ...
    public static Dictionary<PointerNames, int[]> GetOffsets(GameVersion version) {
